...
export default function AllVisitorsPage() {
  ...
  return (
    <div className="flex flex-col gap-6 animate-fade-in pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-4 bg-white p-4 rounded-3xl border border-slate-200 shadow-sm">
        <div className="flex items-center gap-2 bg-slate-100/80 p-1.5 rounded-2xl w-full md:w-auto overflow-x-auto no-scrollbar whitespace-nowrap">
          <button
